...
int main(int argc, char const *argv[]){
	...
	std::cout << "Test de la fonction update_product_quantity()" << std::endl;
	...
	std::cout << "Test de la fonction delete_product()" << std::endl;
	c1.delete_product(p2);
	std::cout << c1;
	std::cout << std::endl;

	std::cout << "Test de la fonction clear()" << std::endl;
	c1.clear_cart();
	std::cout << c1;
}
